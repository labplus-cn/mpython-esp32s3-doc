...
![image](/_static/image/classic/dht11.png){.align-center}
...
![image](/_static/image/classic/dhtconnect.jpg){.align-center}
...
![image](/_static/image/classic/dhtexample.jpg){.align-center}
...
`dht.measure()` 为DHT11测量温湿度数据指令，测量后使用
`dht.temperature()` 、 `dht.humidity()` 获取测量的温湿度值。
::::
