...
3. 点击「Next」，勾选「I accept the agreement」（同意协议），继续「Next」；
4. 选择安装路径（默认即可，无需修改），继续「Next」；
5. 勾选「Create Desktop Icon」（创建桌面快捷方式），点击「Install」开始安装；
...
3. 首次打开时，若提示「无法验证开发者」，右键点击Applications里的Arduino IDE，选择「打开」，再次点击「打开」即可（macOS安全机制）；
...
3. 安装完成后，可通过终端输入 `arduino-ide` 启动，或在应用列表找到图标。
