...
可以在所有输出引脚上启用PWM。但是，有一些限制：所有PWM必须具有相同的频率，并且只有8个通道。
::::
...
- `freq_val` 是PWM频率，0 \< freq ≤ 0x0001312D（十进制：0 \< freq ≤
  78125 Hz）
:::
